...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1641: (x0,x1,x2,x3) => globalThis.firebase_analytics.logEvent(x0,x1,x2,x3),
      _1647: (x0,x1) => globalThis.firebase_analytics.initializeAnalytics(x0,x1),
      _1650: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      _1651: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      _1652: x0 => globalThis.firebase_core.getApp(x0),
      _1653: () => globalThis.firebase_core.getApp(),
      _1656: () => globalThis.firebase_core.SDK_VERSION,
      _1663: x0 => x0.apiKey,
      _1665: x0 => x0.authDomain,
      _1667: x0 => x0.databaseURL,
      _1669: x0 => x0.projectId,
      _1671: x0 => x0.storageBucket,
      _1673: x0 => x0.messagingSenderId,
      _1675: x0 => x0.measurementId,
      _1677: x0 => x0.appId,
      _1679: x0 => x0.name,
      _1680: x0 => x0.options,
      _1689: (x0,x1) => x0.debug(x1),
      _1690: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1690(f,arguments.length,x0) }),
      _1691: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1691(f,arguments.length,x0,x1) }),
      _1692: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1693: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1694: (x0,x1) => x0.createScriptURL(x1),
      _1695: (x0,x1,x2) => x0.createScript(x1,x2),
      _1696: (x0,x1) => x0.appendChild(x1),
      ...
      _1699: () => globalThis.removeSplashFromWeb(),
      _1712: x0 => new Array(x0),
      _1714: x0 => x0.length,
      _1716: (x0,x1) => x0[x1],
      _1717: (x0,x1,x2) => x0[x1] = x2,
      _1720: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1722: x0 => new Int8Array(x0),
      _1723: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1724: x0 => new Uint8Array(x0),
      _1732: x0 => new Int32Array(x0),
      _1736: x0 => new Float32Array(x0),
      _1738: x0 => new Float64Array(x0),
      _1770: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1771: () => new TextDecoder("utf-8", {fatal: true}),
      _1772: () => new TextDecoder("utf-8", {fatal: false}),
      _1773: x0 => new WeakRef(x0),
      _1774: x0 => x0.deref(),
      _1780: Date.now,
      _1782: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1783: s => {
      ...
      _1785: () => typeof dartUseDateNowForTicks !== "undefined",
      _1786: () => 1000 * performance.now(),
      _1787: () => Date.now(),
      _1790: () => new WeakMap(),
      _1791: (map, o) => map.get(o),
      _1792: (map, o, v) => map.set(o, v),
      _1793: () => globalThis.WeakRef,
      _1804: s => JSON.stringify(s),
      _1805: s => printToConsole(s),
      _1806: a => a.join(''),
      _1809: (s, t) => s.split(t),
      ...
      _1813: s => s.trimLeft(),
      _1814: s => s.trimRight(),
      _1816: (s, p, i) => s.indexOf(p, i),
      _1817: (s, p, i) => s.lastIndexOf(p, i),
      _1819: Object.is,
      _1820: s => s.toUpperCase(),
      _1821: s => s.toLowerCase(),
      _1822: (a, i) => a.push(i),
      _1826: a => a.pop(),
      _1827: (a, i) => a.splice(i, 1),
      _1829: (a, s) => a.join(s),
      _1830: (a, s, e) => a.slice(s, e),
      _1833: a => a.length,
      _1835: (a, i) => a[i],
      _1836: (a, i, v) => a[i] = v,
      _1838: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1839: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1840: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1841: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1842: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1843: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1844: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1845: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1847: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1848: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1849: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1850: (t, s) => t.set(s),
      _1852: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1854: o => o.buffer,
      _1855: o => o.byteOffset,
      _1856: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1857: (b, o) => new DataView(b, o),
      _1858: (b, o, l) => new DataView(b, o, l),
      _1859: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1860: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1861: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1862: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1863: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1864: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1865: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1866: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1867: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1868: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1869: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1870: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1873: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1874: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1875: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1876: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1877: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1878: Function.prototype.call.bind(DataView.prototype.setFloat64),
      ...
      _1917: x0 => x0.trustedTypes,
      _1919: (x0,x1) => x0.text = x1,
      _1935: (s, m) => {
        try {
      ...
      _1993: (o, p) => o[p],
      _1994: (o, p, v) => o[p] = v,
      _1995: (o, m, a) => o[m].apply(o, a),
      _1997: o => String(o),
      _1998: (p, s, f) => p.then(s, f),
      _1999: o => {
      ...
      _2013: x0 => x0.index,
      _2018: x0 => x0.flags,
      _2019: x0 => x0.multiline,
      _2020: x0 => x0.ignoreCase,
      _2021: x0 => x0.unicode,
      _2022: x0 => x0.dotAll,
      _2023: (x0,x1) => x0.lastIndex = x1,
      _2025: (o, p) => o[p],
      _2026: (o, p, v) => o[p] = v,
      _2027: (o, p) => delete o[p],
      _2028: x0 => x0.random(),
      _2029: x0 => x0.random(),
      _2033: () => globalThis.Math,
      _2035: Function.prototype.call.bind(Number.prototype.toString),
      _2036: (d, digits) => d.toFixed(digits),
      _3481: (x0,x1) => x0.type = x1,
      _3489: (x0,x1) => x0.crossOrigin = x1,
      _3491: (x0,x1) => x0.text = x1,
      _3966: () => globalThis.window,
      _4031: x0 => x0.navigator,
      _4293: x0 => x0.trustedTypes,
      _4422: x0 => x0.userAgent,
      _6748: () => globalThis.document,
      _6843: x0 => x0.head,
      _13697: () => globalThis.console,
      _13729: x0 => x0.name,
      _13730: x0 => x0.message,
      _13731: x0 => x0.code,
